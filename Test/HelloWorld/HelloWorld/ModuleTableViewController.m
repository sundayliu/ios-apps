...
- (void)viewDidLoad
{
    ...
    moduleArray = [[NSMutableArray alloc]initWithObjects:@"Module", nil];
    
    char moduleList[100][0x100] = {0};
    getProcessModuleList(moduleList,100);
...
{
    static NSString *CellIdentifier = @"ModuleIdentifier";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    // Configure the cell...
    cell.textLabel.text = [moduleArray objectAtIndex:indexPath.row];
